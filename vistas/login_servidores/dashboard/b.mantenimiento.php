...
<div class="container-fluid">
    <h1>Ver informe del permiso laboral mediante tu id de trabajador.</h1><br><br>
    ...
    $consulta = "SELECT id, folio, encargado, sucursal, status, recomendaciones FROM informe WHERE servidor='$buscar'";
